...
public class Cat extends Pet {
    ...
    public Cat(byte[] image, int id, String name, int age, boolean gender, double price, List<Vaccine> vaccinated, String healthStatus, String origin, double weight, String furColor, String description, Supplier supplier, ECatBreed breed, boolean isIndoor, String eyeColor) {
