...
public class Hamster extends Pet {
    ...
    public Hamster(byte[] image, int id, String name, int age, boolean gender, double price,List<Vaccine_Pet> vaccinated, String healthStatus, String origin, double weight, String furColor, String description, Supplier supplier, EHamsterBreed breed, double tailLength) {
