...
public class controllerProgressBarEmployee implements Initializable {
    ...
    public class doword extends Task<Void> {
        ...
        protected Void call() throws Exception {
            ...
            javafx.application.Platform.runLater(() -> {
                try {
                    scenes.switchScene("Employee/sampleHome", "Golden Pet Shop","Employee/applicationHome", true);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            });
